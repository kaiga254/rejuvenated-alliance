    ...
    <footer id="contact" className="bg-slate-900 text-slate-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Your support empowers seniors and strengthens our community. Every
              contribution counts.
            </p>
            <div className="flex flex-col space-y-2">
              <button className="bg-secondary-500 text-white px-4 py-3 rounded-md font-bold hover:bg-amber-600 transition-colors w-full shadow-lg transform hover:-translate-y-0.5">
                Donate Now
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Rejuvenated Seniors Alliance. All
            rights reserved.
          </p>
