...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative w-full h-[600px] sm:h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left">
        <div className="sm:w-2/3 lg:w-1/2">
          ...
          <p className="text-lg sm:text-xl text-primary-50 mb-8 font-light leading-relaxed">
            We are dedicated to ensuring that every senior lives with dignity, purpose, and connection. Join the alliance that is redefining the golden years.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button className="flex items-center justify-center border-2 border-white text-white px-8 py-3 rounded-full font-bold text-lg hover:bg-white/10 transition-colors">
              Volunteer
            </button>
          </div>
        </div>
